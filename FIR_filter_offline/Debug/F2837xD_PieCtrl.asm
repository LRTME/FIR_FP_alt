...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	.dwattr $C$DW$CU, DW_AT_name("../source/device/F2837xD_PieCtrl.c")
...
;	C:\ti\ccsv6\tools\compiler\ti-cgt-c2000_15.12.4.LTS\bin\ac2000.exe -@C:\\Users\\DenisS\\AppData\\Local\\Temp\\0272412 
	.sect	".text:_InitPieCtrl"
	.clink
	.global	_InitPieCtrl
...
$C$DW$2	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$2, DW_AT_TI_begin_file("../source/device/F2837xD_PieCtrl.c")
	.dwattr $C$DW$2, DW_AT_TI_begin_line(0x18)
	.dwattr $C$DW$2, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$2, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 25,column 1,is_stmt,address _InitPieCtrl,isa 0
...
_InitPieCtrl:
	...
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 29,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  29 | DINT;                                                                  
;  31 | //                                                                     
;  32 | // Disable the PIE                                                     
...
;----------------------------------------------------------------------
 setc INTM
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 34,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
	...
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 39,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
;  39 | PieCtrlRegs.PIEIER1.all = 0;                                           
;----------------------------------------------------------------------
        MOV       @_PieCtrlRegs+2,#0    ; [CPU_] |39| 
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 40,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
;  40 | PieCtrlRegs.PIEIER2.all = 0;                                           
;----------------------------------------------------------------------
        MOV       @_PieCtrlRegs+4,#0    ; [CPU_] |40| 
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 41,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
;  41 | PieCtrlRegs.PIEIER3.all = 0;                                           
;----------------------------------------------------------------------
        MOV       @_PieCtrlRegs+6,#0    ; [CPU_] |41| 
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 42,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
;  42 | PieCtrlRegs.PIEIER4.all = 0;                                           
;----------------------------------------------------------------------
        MOV       @_PieCtrlRegs+8,#0    ; [CPU_] |42| 
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 43,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
;  43 | PieCtrlRegs.PIEIER5.all = 0;                                           
;----------------------------------------------------------------------
        MOV       @_PieCtrlRegs+10,#0   ; [CPU_] |43| 
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 44,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
;  44 | PieCtrlRegs.PIEIER6.all = 0;                                           
;----------------------------------------------------------------------
        MOV       @_PieCtrlRegs+12,#0   ; [CPU_] |44| 
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 45,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
;  45 | PieCtrlRegs.PIEIER7.all = 0;                                           
;----------------------------------------------------------------------
        MOV       @_PieCtrlRegs+14,#0   ; [CPU_] |45| 
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 46,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
;  46 | PieCtrlRegs.PIEIER8.all = 0;                                           
;----------------------------------------------------------------------
        MOV       @_PieCtrlRegs+16,#0   ; [CPU_] |46| 
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 47,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
;  47 | PieCtrlRegs.PIEIER9.all = 0;                                           
;----------------------------------------------------------------------
        MOV       @_PieCtrlRegs+18,#0   ; [CPU_] |47| 
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 48,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
;  48 | PieCtrlRegs.PIEIER10.all = 0;                                          
;----------------------------------------------------------------------
        MOV       @_PieCtrlRegs+20,#0   ; [CPU_] |48| 
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 49,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
;  49 | PieCtrlRegs.PIEIER11.all = 0;                                          
;----------------------------------------------------------------------
        MOV       @_PieCtrlRegs+22,#0   ; [CPU_] |49| 
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 50,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
	...
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 55,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
;  55 | PieCtrlRegs.PIEIFR1.all = 0;                                           
;----------------------------------------------------------------------
        MOV       @_PieCtrlRegs+3,#0    ; [CPU_] |55| 
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 56,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
;  56 | PieCtrlRegs.PIEIFR2.all = 0;                                           
;----------------------------------------------------------------------
        MOV       @_PieCtrlRegs+5,#0    ; [CPU_] |56| 
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 57,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
;  57 | PieCtrlRegs.PIEIFR3.all = 0;                                           
;----------------------------------------------------------------------
        MOV       @_PieCtrlRegs+7,#0    ; [CPU_] |57| 
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 58,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
;  58 | PieCtrlRegs.PIEIFR4.all = 0;                                           
;----------------------------------------------------------------------
        MOV       @_PieCtrlRegs+9,#0    ; [CPU_] |58| 
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 59,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
;  59 | PieCtrlRegs.PIEIFR5.all = 0;                                           
;----------------------------------------------------------------------
        MOV       @_PieCtrlRegs+11,#0   ; [CPU_] |59| 
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 60,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
;  60 | PieCtrlRegs.PIEIFR6.all = 0;                                           
;----------------------------------------------------------------------
        MOV       @_PieCtrlRegs+13,#0   ; [CPU_] |60| 
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 61,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
;  61 | PieCtrlRegs.PIEIFR7.all = 0;                                           
;----------------------------------------------------------------------
        MOV       @_PieCtrlRegs+15,#0   ; [CPU_] |61| 
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 62,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
;  62 | PieCtrlRegs.PIEIFR8.all = 0;                                           
;----------------------------------------------------------------------
        MOV       @_PieCtrlRegs+17,#0   ; [CPU_] |62| 
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 63,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
;  63 | PieCtrlRegs.PIEIFR9.all = 0;                                           
;----------------------------------------------------------------------
        MOV       @_PieCtrlRegs+19,#0   ; [CPU_] |63| 
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 64,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
;  64 | PieCtrlRegs.PIEIFR10.all = 0;                                          
;----------------------------------------------------------------------
        MOV       @_PieCtrlRegs+21,#0   ; [CPU_] |64| 
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 65,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
;  65 | PieCtrlRegs.PIEIFR11.all = 0;                                          
;----------------------------------------------------------------------
        MOV       @_PieCtrlRegs+23,#0   ; [CPU_] |65| 
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 66,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
;  66 | PieCtrlRegs.PIEIFR12.all = 0;                                          
;----------------------------------------------------------------------
        MOV       @_PieCtrlRegs+25,#0   ; [CPU_] |66| 
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 67,column 1,is_stmt,isa 0
        SPM       #0                    ; [CPU_] 
$C$DW$3	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$3, DW_AT_TI_return
        ...
        LRETR     ; [CPU_] 
        ; return occurs ; [] 
	.dwattr $C$DW$2, DW_AT_TI_end_file("../source/device/F2837xD_PieCtrl.c")
	.dwattr $C$DW$2, DW_AT_TI_end_line(0x43)
	.dwattr $C$DW$2, DW_AT_TI_end_column(0x01)
	.dwendentry
	.dwendtag $C$DW$2

	.sect	".text:_EnableInterrupts"
	.clink
...
$C$DW$4	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$4, DW_AT_TI_begin_file("../source/device/F2837xD_PieCtrl.c")
	.dwattr $C$DW$4, DW_AT_TI_begin_line(0x48)
	.dwattr $C$DW$4, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$4, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 73,column 1,is_stmt,address _EnableInterrupts,isa 0
...
_EnableInterrupts:
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 77,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
	...
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 82,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
	...
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 87,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  87 | EINT;                                                                  
;----------------------------------------------------------------------
 clrc INTM
	.dwpsn	file "../source/device/F2837xD_PieCtrl.c",line 88,column 1,is_stmt,isa 0
        SPM       #0                    ; [CPU_] 
$C$DW$5	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$5, DW_AT_TI_return
        ...
        LRETR     ; [CPU_] 
        ; return occurs ; [] 
	.dwattr $C$DW$4, DW_AT_TI_end_file("../source/device/F2837xD_PieCtrl.c")
