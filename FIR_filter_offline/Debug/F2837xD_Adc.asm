...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	.dwattr $C$DW$CU, DW_AT_name("../source/device/F2837xD_Adc.c")
...
;	C:\ti\ccsv6\tools\compiler\ti-cgt-c2000_15.12.4.LTS\bin\ac2000.exe -@C:\\Users\\DenisS\\AppData\\Local\\Temp\\0369212 
	.sect	".text:_AdcSetMode"
	.clink
	.global	_AdcSetMode
...
$C$DW$5	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$5, DW_AT_TI_begin_file("../source/device/F2837xD_Adc.c")
	.dwattr $C$DW$5, DW_AT_TI_begin_line(0x18)
	.dwattr $C$DW$5, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$5, DW_AT_TI_max_frame_size(-8)
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 25,column 1,is_stmt,address _AdcSetMode,isa 0
...
;----------------------------------------------------------------------
;  24 | void AdcSetMode(Uint16 adc, Uint16 resolution, Uint16 signalmode)      
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
;  26 | Uint16 adcOffsetTrimOTPIndex; //index into OTP table of ADC offset trim
;     | s                                                                      
;  27 | Uint16 adcOffsetTrim;         //temporary ADC offset trim              
;  29 | //                                                                     
;  30 | //re-populate INL trim                                                 
;  31 | //                                                                     
;----------------------------------------------------------------------
        MOV       *-SP[3],AR4           ; [CPU_] |25| 
        MOV       *-SP[2],AH            ; [CPU_] |25| 
        MOV       *-SP[1],AL            ; [CPU_] |25| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 32,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  32 | CalAdcINL(adc);                                                        
;----------------------------------------------------------------------
$C$DW$14	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$14, DW_AT_TI_call
        ...
        LCR       #_CalAdcINL           ; [CPU_] |32| 
        ; call occurs [#_CalAdcINL] ; [] |32| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 34,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  34 | if(0xFFFF != *((Uint16*)GetAdcOffsetTrimOTP))                          
;  36 |     //                                                                 
;  37 |     //offset trim function is programmed into OTP, so call it          
;  38 |     //                                                                 
;  40 |     //                                                                 
;  41 |     //calculate the index into OTP table of offset trims and call      
;  42 |     //function to return the correct offset trim                       
;  43 |     //                                                                 
;----------------------------------------------------------------------
        MOVL      XAR4,#459692          ; [CPU_U] |34| 
        MOVU      ACC,*+XAR4[0]         ; [CPU_] |34| 
        MOVL      XAR4,#65535           ; [CPU_U] |34| 
        CMPL      ACC,XAR4              ; [CPU_] |34| 
        B         $C$L1,EQ              ; [CPU_] |34| 
        ; branchcc occurs ; [] |34| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 44,column 9,is_stmt,isa 0
;----------------------------------------------------------------------
;  44 | adcOffsetTrimOTPIndex = 4*adc + 2*resolution + 1*signalmode;           
;----------------------------------------------------------------------
        MOV       ACC,*-SP[1] << #2     ; [CPU_] |44| 
        MOVZ      AR6,AL                ; [CPU_] |44| 
        MOV       ACC,*-SP[2] << #1     ; [CPU_] |44| 
        ADD       AL,AR6                ; [CPU_] |44| 
        ADD       AL,*-SP[3]            ; [CPU_] |44| 
        MOV       *-SP[4],AL            ; [CPU_] |44| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 45,column 9,is_stmt,isa 0
;----------------------------------------------------------------------
;  45 | adcOffsetTrim = (*GetAdcOffsetTrimOTP)(adcOffsetTrimOTPIndex);         
;----------------------------------------------------------------------
        MOVL      XAR7,#459692          ; [CPU_U] |45| 
$C$DW$15	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$15, DW_AT_TI_indirect
        ...
        ; call occurs [XAR7] ; [] |45| 
        MOV       *-SP[5],AL            ; [CPU_] |45| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 46,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  47 | else                                                                   
;  49 |     //                                                                 
;  50 |     //offset trim function is not populated, so set offset trim to 0   
;  51 |     //                                                                 
;----------------------------------------------------------------------
        B         $C$L6,UNC             ; [CPU_] |46| 
        ; branch occurs ; [] |46| 
$C$L1:    
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 52,column 9,is_stmt,isa 0
;----------------------------------------------------------------------
;  52 | adcOffsetTrim = 0;                                                     
;  55 | //                                                                     
;  56 | //Apply the resolution and signalmode to the specified ADC.            
;  57 | //Also apply the offset trim and, if needed, linearity trim correction.
;  58 | //                                                                     
;----------------------------------------------------------------------
        MOV       *-SP[5],#0            ; [CPU_] |52| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 59,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  59 | switch(adc)                                                            
;  61 |     case ADC_ADCA:                                                     
;----------------------------------------------------------------------
        ...
        ; branch occurs ; [] |59| 
$C$L2:    
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 62,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
;  62 | AdcaRegs.ADCCTL2.bit.RESOLUTION = resolution;                          
;----------------------------------------------------------------------
        MOVW      DP,#_AdcaRegs+1       ; [CPU_U] 
        MOV       AL,*-SP[2]            ; [CPU_] |62| 
        AND       AH,@_AdcaRegs+1,#0xffbf ; [CPU_] |62| 
        ANDB      AL,#0x01              ; [CPU_] |62| 
        LSL       AL,6                  ; [CPU_] |62| 
        OR        AL,AH                 ; [CPU_] |62| 
        MOV       @_AdcaRegs+1,AL       ; [CPU_] |62| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 63,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
;  63 | AdcaRegs.ADCCTL2.bit.SIGNALMODE = signalmode;                          
;----------------------------------------------------------------------
        MOV       AL,*-SP[3]            ; [CPU_] |63| 
        ANDB      AL,#0x01              ; [CPU_] |63| 
        AND       AH,@_AdcaRegs+1,#0xff7f ; [CPU_] |63| 
        LSL       AL,7                  ; [CPU_] |63| 
        OR        AL,AH                 ; [CPU_] |63| 
        MOV       @_AdcaRegs+1,AL       ; [CPU_] |63| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 64,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
;  64 | AdcaRegs.ADCOFFTRIM.all = adcOffsetTrim;                               
;----------------------------------------------------------------------
        MOV       AL,*-SP[5]            ; [CPU_] |64| 
        MOV       @_AdcaRegs+59,AL      ; [CPU_] |64| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 65,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
;  65 | if(ADC_RESOLUTION_12BIT == resolution)                                 
;  67 |     //                                                                 
;  68 |     //12-bit linearity trim workaround                                 
;  69 |     //                                                                 
;----------------------------------------------------------------------
        MOV       AL,*-SP[2]            ; [CPU_] |65| 
        B         $C$L7,NEQ             ; [CPU_] |65| 
        ; branchcc occurs ; [] |65| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 70,column 17,is_stmt,isa 0
;----------------------------------------------------------------------
;  70 | AdcaRegs.ADCINLTRIM1 &= 0xFFFF0000;                                    
;----------------------------------------------------------------------
        MOVW      DP,#_AdcaRegs+112     ; [CPU_U] 
        AND       @_AdcaRegs+112,#0     ; [CPU_] |70| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 71,column 17,is_stmt,isa 0
;----------------------------------------------------------------------
;  71 | AdcaRegs.ADCINLTRIM2 &= 0xFFFF0000;                                    
;----------------------------------------------------------------------
        AND       @_AdcaRegs+114,#0     ; [CPU_] |71| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 72,column 17,is_stmt,isa 0
;----------------------------------------------------------------------
;  72 | AdcaRegs.ADCINLTRIM4 &= 0xFFFF0000;                                    
;----------------------------------------------------------------------
        AND       @_AdcaRegs+118,#0     ; [CPU_] |72| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 73,column 17,is_stmt,isa 0
;----------------------------------------------------------------------
;  73 | AdcaRegs.ADCINLTRIM5 &= 0xFFFF0000;                                    
;----------------------------------------------------------------------
        AND       @_AdcaRegs+120,#0     ; [CPU_] |73| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 75,column 9,is_stmt,isa 0
;----------------------------------------------------------------------
;  75 | break;                                                                 
;  76 | case ADC_ADCB:                                                         
;----------------------------------------------------------------------
        ...
        ; branch occurs ; [] |75| 
$C$L3:    
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 77,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
;  77 | AdcbRegs.ADCCTL2.bit.RESOLUTION = resolution;                          
;----------------------------------------------------------------------
        MOVW      DP,#_AdcbRegs+1       ; [CPU_U] 
        MOV       AL,*-SP[2]            ; [CPU_] |77| 
        AND       AH,@_AdcbRegs+1,#0xffbf ; [CPU_] |77| 
        ANDB      AL,#0x01              ; [CPU_] |77| 
        LSL       AL,6                  ; [CPU_] |77| 
        OR        AL,AH                 ; [CPU_] |77| 
        MOV       @_AdcbRegs+1,AL       ; [CPU_] |77| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 78,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
;  78 | AdcbRegs.ADCCTL2.bit.SIGNALMODE = signalmode;                          
;----------------------------------------------------------------------
        MOV       AL,*-SP[3]            ; [CPU_] |78| 
        ANDB      AL,#0x01              ; [CPU_] |78| 
        AND       AH,@_AdcbRegs+1,#0xff7f ; [CPU_] |78| 
        LSL       AL,7                  ; [CPU_] |78| 
        OR        AL,AH                 ; [CPU_] |78| 
        MOV       @_AdcbRegs+1,AL       ; [CPU_] |78| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 79,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
;  79 | AdcbRegs.ADCOFFTRIM.all = adcOffsetTrim;                               
;----------------------------------------------------------------------
        MOV       AL,*-SP[5]            ; [CPU_] |79| 
        MOV       @_AdcbRegs+59,AL      ; [CPU_] |79| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 80,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
;  80 | if(ADC_RESOLUTION_12BIT == resolution)                                 
;  82 |     //                                                                 
;  83 |     //12-bit linearity trim workaround                                 
;  84 |     //                                                                 
;----------------------------------------------------------------------
        MOV       AL,*-SP[2]            ; [CPU_] |80| 
        B         $C$L7,NEQ             ; [CPU_] |80| 
        ; branchcc occurs ; [] |80| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 85,column 17,is_stmt,isa 0
;----------------------------------------------------------------------
;  85 | AdcbRegs.ADCINLTRIM1 &= 0xFFFF0000;                                    
;----------------------------------------------------------------------
        MOVW      DP,#_AdcbRegs+112     ; [CPU_U] 
        AND       @_AdcbRegs+112,#0     ; [CPU_] |85| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 86,column 17,is_stmt,isa 0
;----------------------------------------------------------------------
;  86 | AdcbRegs.ADCINLTRIM2 &= 0xFFFF0000;                                    
;----------------------------------------------------------------------
        AND       @_AdcbRegs+114,#0     ; [CPU_] |86| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 87,column 17,is_stmt,isa 0
;----------------------------------------------------------------------
;  87 | AdcbRegs.ADCINLTRIM4 &= 0xFFFF0000;                                    
;----------------------------------------------------------------------
        AND       @_AdcbRegs+118,#0     ; [CPU_] |87| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 88,column 17,is_stmt,isa 0
;----------------------------------------------------------------------
;  88 | AdcbRegs.ADCINLTRIM5 &= 0xFFFF0000;                                    
;----------------------------------------------------------------------
        AND       @_AdcbRegs+120,#0     ; [CPU_] |88| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 90,column 9,is_stmt,isa 0
;----------------------------------------------------------------------
;  90 | break;                                                                 
;  91 | case ADC_ADCC:                                                         
;----------------------------------------------------------------------
        ...
        ; branch occurs ; [] |90| 
$C$L4:    
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 92,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
;  92 | AdccRegs.ADCCTL2.bit.RESOLUTION = resolution;                          
;----------------------------------------------------------------------
        MOVW      DP,#_AdccRegs+1       ; [CPU_U] 
        MOV       AL,*-SP[2]            ; [CPU_] |92| 
        AND       AH,@_AdccRegs+1,#0xffbf ; [CPU_] |92| 
        ANDB      AL,#0x01              ; [CPU_] |92| 
        LSL       AL,6                  ; [CPU_] |92| 
        OR        AL,AH                 ; [CPU_] |92| 
        MOV       @_AdccRegs+1,AL       ; [CPU_] |92| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 93,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
;  93 | AdccRegs.ADCCTL2.bit.SIGNALMODE = signalmode;                          
;----------------------------------------------------------------------
        MOV       AL,*-SP[3]            ; [CPU_] |93| 
        ANDB      AL,#0x01              ; [CPU_] |93| 
        AND       AH,@_AdccRegs+1,#0xff7f ; [CPU_] |93| 
        LSL       AL,7                  ; [CPU_] |93| 
        OR        AL,AH                 ; [CPU_] |93| 
        MOV       @_AdccRegs+1,AL       ; [CPU_] |93| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 94,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
;  94 | AdccRegs.ADCOFFTRIM.all = adcOffsetTrim;                               
;----------------------------------------------------------------------
        MOV       AL,*-SP[5]            ; [CPU_] |94| 
        MOV       @_AdccRegs+59,AL      ; [CPU_] |94| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 95,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
;  95 | if(ADC_RESOLUTION_12BIT == resolution)                                 
;  97 |     //                                                                 
;  98 |     //12-bit linearity trim workaround                                 
;  99 |     //                                                                 
;----------------------------------------------------------------------
        MOV       AL,*-SP[2]            ; [CPU_] |95| 
        B         $C$L7,NEQ             ; [CPU_] |95| 
        ; branchcc occurs ; [] |95| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 100,column 17,is_stmt,isa 0
;----------------------------------------------------------------------
; 100 | AdccRegs.ADCINLTRIM1 &= 0xFFFF0000;                                    
;----------------------------------------------------------------------
        MOVW      DP,#_AdccRegs+112     ; [CPU_U] 
        AND       @_AdccRegs+112,#0     ; [CPU_] |100| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 101,column 17,is_stmt,isa 0
;----------------------------------------------------------------------
; 101 | AdccRegs.ADCINLTRIM2 &= 0xFFFF0000;                                    
;----------------------------------------------------------------------
        AND       @_AdccRegs+114,#0     ; [CPU_] |101| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 102,column 17,is_stmt,isa 0
;----------------------------------------------------------------------
; 102 | AdccRegs.ADCINLTRIM4 &= 0xFFFF0000;                                    
;----------------------------------------------------------------------
        AND       @_AdccRegs+118,#0     ; [CPU_] |102| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 103,column 17,is_stmt,isa 0
;----------------------------------------------------------------------
; 103 | AdccRegs.ADCINLTRIM5 &= 0xFFFF0000;                                    
;----------------------------------------------------------------------
        AND       @_AdccRegs+120,#0     ; [CPU_] |103| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 105,column 9,is_stmt,isa 0
;----------------------------------------------------------------------
; 105 | break;                                                                 
; 106 | case ADC_ADCD:                                                         
;----------------------------------------------------------------------
        ...
        ; branch occurs ; [] |105| 
$C$L5:    
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 107,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 107 | AdcdRegs.ADCCTL2.bit.RESOLUTION = resolution;                          
;----------------------------------------------------------------------
        MOVW      DP,#_AdcdRegs+1       ; [CPU_U] 
        MOV       AL,*-SP[2]            ; [CPU_] |107| 
        AND       AH,@_AdcdRegs+1,#0xffbf ; [CPU_] |107| 
        ANDB      AL,#0x01              ; [CPU_] |107| 
        LSL       AL,6                  ; [CPU_] |107| 
        OR        AL,AH                 ; [CPU_] |107| 
        MOV       @_AdcdRegs+1,AL       ; [CPU_] |107| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 108,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 108 | AdcdRegs.ADCCTL2.bit.SIGNALMODE = signalmode;                          
;----------------------------------------------------------------------
        MOV       AL,*-SP[3]            ; [CPU_] |108| 
        ANDB      AL,#0x01              ; [CPU_] |108| 
        AND       AH,@_AdcdRegs+1,#0xff7f ; [CPU_] |108| 
        LSL       AL,7                  ; [CPU_] |108| 
        OR        AL,AH                 ; [CPU_] |108| 
        MOV       @_AdcdRegs+1,AL       ; [CPU_] |108| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 109,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 109 | AdcdRegs.ADCOFFTRIM.all = adcOffsetTrim;                               
;----------------------------------------------------------------------
        MOV       AL,*-SP[5]            ; [CPU_] |109| 
        MOV       @_AdcdRegs+59,AL      ; [CPU_] |109| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 110,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 110 | if(ADC_RESOLUTION_12BIT == resolution)                                 
; 112 |     //                                                                 
; 113 |     //12-bit linearity trim workaround                                 
; 114 |     //                                                                 
;----------------------------------------------------------------------
        MOV       AL,*-SP[2]            ; [CPU_] |110| 
        B         $C$L7,NEQ             ; [CPU_] |110| 
        ; branchcc occurs ; [] |110| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 115,column 17,is_stmt,isa 0
;----------------------------------------------------------------------
; 115 | AdcdRegs.ADCINLTRIM1 &= 0xFFFF0000;                                    
;----------------------------------------------------------------------
        MOVW      DP,#_AdcdRegs+112     ; [CPU_U] 
        AND       @_AdcdRegs+112,#0     ; [CPU_] |115| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 116,column 17,is_stmt,isa 0
;----------------------------------------------------------------------
; 116 | AdcdRegs.ADCINLTRIM2 &= 0xFFFF0000;                                    
;----------------------------------------------------------------------
        AND       @_AdcdRegs+114,#0     ; [CPU_] |116| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 117,column 17,is_stmt,isa 0
;----------------------------------------------------------------------
; 117 | AdcdRegs.ADCINLTRIM4 &= 0xFFFF0000;                                    
;----------------------------------------------------------------------
        AND       @_AdcdRegs+118,#0     ; [CPU_] |117| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 118,column 17,is_stmt,isa 0
;----------------------------------------------------------------------
; 118 | AdcdRegs.ADCINLTRIM5 &= 0xFFFF0000;                                    
;----------------------------------------------------------------------
        AND       @_AdcdRegs+120,#0     ; [CPU_] |118| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 120,column 9,is_stmt,isa 0
;----------------------------------------------------------------------
; 120 | break;                                                                 
;----------------------------------------------------------------------
        B         $C$L7,UNC             ; [CPU_] |120| 
...
$C$DW$16	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$16, DW_AT_TI_return
        ...
        LRETR     ; [CPU_] 
        ; return occurs ; [] 
	.dwattr $C$DW$5, DW_AT_TI_end_file("../source/device/F2837xD_Adc.c")
	.dwattr $C$DW$5, DW_AT_TI_end_line(0x7a)
	.dwattr $C$DW$5, DW_AT_TI_end_column(0x01)
	.dwendentry
	.dwendtag $C$DW$5

	.sect	".text:_CalAdcINL"
	.clink
	.global	_CalAdcINL
...
$C$DW$17	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$17, DW_AT_TI_begin_file("../source/device/F2837xD_Adc.c")
	.dwattr $C$DW$17, DW_AT_TI_begin_line(0x81)
	.dwattr $C$DW$17, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$17, DW_AT_TI_max_frame_size(-4)
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 130,column 1,is_stmt,address _CalAdcINL,isa 0
...
$C$DW$19	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$19, DW_AT_location[DW_OP_breg20 -1]
        ...
        MOV       *-SP[1],AL            ; [CPU_] |130| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 131,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 131 | switch(adc)                                                            
; 133 |     case ADC_ADCA:                                                     
;----------------------------------------------------------------------
        ...
        ; branch occurs ; [] |131| 
$C$L8:    
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 134,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 134 | if(0xFFFF != *((Uint16*)CalAdcaINL))                                   
; 136 |     //                                                                 
; 137 |     //trim function is programmed into OTP, so call it                 
; 138 |     //                                                                 
;----------------------------------------------------------------------
        MOVL      XAR4,#459700          ; [CPU_U] |134| 
        MOVU      ACC,*+XAR4[0]         ; [CPU_] |134| 
        MOVL      XAR4,#65535           ; [CPU_U] |134| 
        CMPL      ACC,XAR4              ; [CPU_] |134| 
        B         $C$L13,EQ             ; [CPU_] |134| 
        ; branchcc occurs ; [] |134| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 139,column 17,is_stmt,isa 0
;----------------------------------------------------------------------
; 139 | (*CalAdcaINL)();                                                       
;----------------------------------------------------------------------
        MOVL      XAR7,#459700          ; [CPU_U] |139| 
$C$DW$20	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$20, DW_AT_TI_indirect
        ...
        LCR       *XAR7                 ; [CPU_] |139| 
        ; call occurs [XAR7] ; [] |139| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 140,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 141 | else                                                                   
; 143 |     //                                                                 
; 144 |     //do nothing, no INL trim function populated                       
; 145 |     //                                                                 
; 147 | break;                                                                 
; 148 | case ADC_ADCB:                                                         
;----------------------------------------------------------------------
        B         $C$L13,UNC            ; [CPU_] |140| 
        ; branch occurs ; [] |140| 
$C$L9:    
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 149,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 149 | if(0xFFFF != *((Uint16*)CalAdcbINL))                                   
; 151 |     //                                                                 
; 152 |     //trim function is programmed into OTP, so call it                 
; 153 |     //                                                                 
;----------------------------------------------------------------------
        MOVL      XAR4,#459698          ; [CPU_U] |149| 
        MOVU      ACC,*+XAR4[0]         ; [CPU_] |149| 
        MOVL      XAR4,#65535           ; [CPU_U] |149| 
        CMPL      ACC,XAR4              ; [CPU_] |149| 
        B         $C$L13,EQ             ; [CPU_] |149| 
        ; branchcc occurs ; [] |149| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 154,column 17,is_stmt,isa 0
;----------------------------------------------------------------------
; 154 | (*CalAdcbINL)();                                                       
;----------------------------------------------------------------------
        MOVL      XAR7,#459698          ; [CPU_U] |154| 
$C$DW$21	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$21, DW_AT_TI_indirect
        ...
        LCR       *XAR7                 ; [CPU_] |154| 
        ; call occurs [XAR7] ; [] |154| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 155,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 156 | else                                                                   
; 158 |     //                                                                 
; 159 |     //do nothing, no INL trim function populated                       
; 160 |     //                                                                 
; 162 | break;                                                                 
; 163 | case ADC_ADCC:                                                         
;----------------------------------------------------------------------
        B         $C$L13,UNC            ; [CPU_] |155| 
        ; branch occurs ; [] |155| 
$C$L10:    
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 164,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 164 | if(0xFFFF != *((Uint16*)CalAdccINL))                                   
; 166 |     //                                                                 
; 167 |     //trim function is programmed into OTP, so call it                 
; 168 |     //                                                                 
;----------------------------------------------------------------------
        MOVL      XAR4,#459696          ; [CPU_U] |164| 
        MOVU      ACC,*+XAR4[0]         ; [CPU_] |164| 
        MOVL      XAR4,#65535           ; [CPU_U] |164| 
        CMPL      ACC,XAR4              ; [CPU_] |164| 
        B         $C$L13,EQ             ; [CPU_] |164| 
        ; branchcc occurs ; [] |164| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 169,column 17,is_stmt,isa 0
;----------------------------------------------------------------------
; 169 | (*CalAdccINL)();                                                       
;----------------------------------------------------------------------
        MOVL      XAR7,#459696          ; [CPU_U] |169| 
$C$DW$22	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 170,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 171 | else                                                                   
; 173 |     //                                                                 
; 174 |     //do nothing, no INL trim function populated                       
; 175 |     //                                                                 
; 177 | break;                                                                 
; 178 | case ADC_ADCD:                                                         
;----------------------------------------------------------------------
        B         $C$L13,UNC            ; [CPU_] |170| 
        ; branch occurs ; [] |170| 
$C$L11:    
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 179,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 179 | if(0xFFFF != *((Uint16*)CalAdcdINL))                                   
; 181 |     //                                                                 
; 182 |     //trim function is programmed into OTP, so call it                 
; 183 |     //                                                                 
;----------------------------------------------------------------------
        MOVL      XAR4,#459694          ; [CPU_U] |179| 
        MOVU      ACC,*+XAR4[0]         ; [CPU_] |179| 
        MOVL      XAR4,#65535           ; [CPU_U] |179| 
        CMPL      ACC,XAR4              ; [CPU_] |179| 
        B         $C$L13,EQ             ; [CPU_] |179| 
        ; branchcc occurs ; [] |179| 
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 184,column 17,is_stmt,isa 0
;----------------------------------------------------------------------
; 184 | (*CalAdcdINL)();                                                       
;----------------------------------------------------------------------
        MOVL      XAR7,#459694          ; [CPU_U] |184| 
$C$DW$23	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 185,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 186 | else                                                                   
; 188 |     //                                                                 
; 189 |     //do nothing, no INL trim function populated                       
; 190 |     //                                                                 
; 192 | break;                                                                 
;----------------------------------------------------------------------
        B         $C$L13,UNC            ; [CPU_] |185| 
        ; branch occurs ; [] |185| 
$C$L12:    
	.dwpsn	file "../source/device/F2837xD_Adc.c",line 131,column 5,is_stmt,isa 0
        CMPB      AL,#0                 ; [CPU_] |131| 
...
$C$DW$24	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$24, DW_AT_TI_return
        ...
        LRETR     ; [CPU_] 
        ; return occurs ; [] 
	.dwattr $C$DW$17, DW_AT_TI_end_file("../source/device/F2837xD_Adc.c")
	.dwattr $C$DW$17, DW_AT_TI_end_line(0xc2)
